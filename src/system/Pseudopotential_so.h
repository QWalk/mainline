...
#ifndef PSEUDOPOTENTIAL_SO_H_INCLUDED
#define PSEUDOPOTENTIAL_SO_H_INCLUDED
...
class Pseudopotential_so
{
public:
  Pseudopotential_so():maxaip(85)
  {deterministic=0;}
...
*/
  ...
  */
  ...
  void getRadialOut(int at, int spin, Sample_point *sample,
    ...
    getRadial(at, spin, sample, r, v_jl);//This is completely the same with getRadial. we redefine this so as not to mix with the original private one.
  }
  ~Pseudopotential_so();
...
#endif //PSEUDOPOTENTIAL_SO_H_INCLUDED
//------------------------------------------------------------------------
