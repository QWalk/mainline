...
def basis_section(struct,params=[0.2,2,3]):
  ...
  basisstring=""
  for e in elements:
    basisstring+=modify_basis(e,library_directory+"BFD_Library.xml",params=params)
  return basisstring
...
class Cif2Crystal:
  ...
  def run(self,job_record):
    #TODO: support shrink, supercell,kmesh, initial_spin,
    #charge,pseudopotential
