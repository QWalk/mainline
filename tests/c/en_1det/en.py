...
plt.errorbar(np.arange(len(E)),E,yerr=Err,label="Test 1")
plt.plot(np.arange(len(E)), -5.31003954*np.ones(len(E)),'--',label="Test 1,2,4,5 VMC")
E=[]
Err=[]
data=np.zeros(10000)
f=open('en2.out','r')
...
plt.plot(np.arange(len(E)), -3.99430455*np.ones(len(E)),'--',label="Test 3,6 VMC")
E=[]
Err=[]
data=np.zeros(10000)
f=open('en4.out','r')
...
plt.title("Single Determinant C Test")
